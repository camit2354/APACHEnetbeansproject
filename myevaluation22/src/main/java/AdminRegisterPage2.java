...
public class AdminRegisterPage2 extends JFrame
        ...
        submit.addActionListener(new ActionListener() {
            ...
            {          String error="";
                ...
                try{
                    ...
                    {
                        choice =  JOptionPane.showConfirmDialog(null," YOU ENTERED  invaliD data: DO YOU WANT CONTINUE REGISTRATION "+error, "INCOMPLETE-REGISTEr ",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE);
                        switch(choice)
                        {
                            case JOptionPane.YES_OPTION :
